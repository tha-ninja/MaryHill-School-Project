...
<div class="row">
							<div class="col-xs-12">
								<button type="button" id="btn_add" class="btn btn-info fa fa-plus"> Record Merit</button>
								...
								<table id="dynamic-table" class="table table-striped table-bordered table-hover">
									...
									<tbody>
										...
										<td>
											@if($value->admin_id)
											@php
												$admin = App\User::select('name')->where('id',$value->admin_id)->first();
												echo $admin->name;
											@endphp
											@endif
											</td>
                    ...
                    <div class="modal-dialog modal-sm" style="width: 500px">
                      <div class="modal-content">
                        <form action="{{ route('merit.store') }}" method="POST" id="add_form" autocomplete="OFF">
                          {{csrf_field()}}
                        <div class="modal-header">
                          <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">×</span>
                          </button>
                          <h4 class="modal-title" id="myModalLabel2">Record Merit</h4>
                        </div>
                        <div class="modal-body">
                        	...
                        	<div class="form-group">
                        		...
                        		<select class="form-control" id="case_id" name="case_id" required="">
                        			<option value="" disabled="" selected="">Select Merit</option>
